...
This format can be added to Fail2Ban to block the associated IP address. See <a href="http://wiki.qmailtoaster.org/index.php?title=Fail2ban" target="_blank">QMT wiki</a>
